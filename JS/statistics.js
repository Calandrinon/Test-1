...
function updateStatisticsDisplay() {
  ...
  if (totalChecksElem) totalChecksElem.textContent = `${100 + totalChecks}`;
  if (eligiblePilon1Elem)
    eligiblePilon1Elem.textContent = `${100 + eligiblePilon1}`;
  if (eligiblePilon2Elem)
    eligiblePilon2Elem.textContent = `${100 + eligiblePilon2}`;
  if (visitCountElem) visitCountElem.textContent = `${100 + visitCount}`;
}
